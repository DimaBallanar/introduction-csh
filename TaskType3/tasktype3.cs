...
if (yu.Length < 5)
{
    if (int.TryParse(yu, out int strokachislo)) { if (yu[0]%2==0 && yu[1]%2==0 && yu[2]%2==0 && yu[3]%2==0){Console.WriteLine($"{yu[0]} кратно 2, {yu[1]} кратно 2, {yu[2]} кратно 2, {yu[3]} кратно 2");}} 
